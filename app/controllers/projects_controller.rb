class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        format.html { redirect_to root_url, notice: 'Project was created.' }
      else
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to root_url, notice: 'Project was updated.' }
      else
  ...
  def destroy
    @project.destroy
    respond_to do |format|
      format.html { redirect_to root_url, notice: 'Project was destroyed.' }
  ...
  def require_same_user
    unless current_user.id == @project.owner || current_user.is_admin?
